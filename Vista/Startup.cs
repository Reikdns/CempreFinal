...
namespace Vista {
    public class Startup {
        ...
        public void ConfigureServices (IServiceCollection services) {
            ...
            services.AddDbContext<CempreContext> (p => p.UseSqlServer (connectionString));
            ...
            services.AddSwaggerGen (c => {
                c.SwaggerDoc ("v1", new OpenApiInfo {
                    Version = "v1",
                        Title = "Gestión de api CEMPRE",
                        Description = "API para la gestión de personas - ASP.NET Core Web API",
                        TermsOfService = new Uri ("https://cla.dotnetfoundation.org/"),
                        Contact = new OpenApiContact {
                            Name = "Reinaldo Durán N. & Sebastian Camacho",
                                Email = string.Empty,
